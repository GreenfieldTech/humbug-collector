...
echo 	"+-----------------------------------------------------+"
echo 	"| humbug-collector, v.0.8.2 (c) 2011 Humbug Labs Ltd. |"
echo 	"+-----------------------------------------------------+"
...
%defattr(-,root,root)
%dir /etc/humbug
%config(noreplace) /etc/humbug/humbug.conf
...
- Fixed crash on Dial event in Asterisk 1.4 
* Wed Mar 7 2012 Igor Ratgauzer <igor@humbuglabs.org> - 0.8-0
- Added blacklist
